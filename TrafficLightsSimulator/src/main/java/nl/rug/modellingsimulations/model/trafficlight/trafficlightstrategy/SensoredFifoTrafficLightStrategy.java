...
public class SensoredFifoTrafficLightStrategy implements TrafficLightStrategy {
    ...
    public SensoredFifoTrafficLightStrategy(TrafficLightJunction trafficLightJunction) {
