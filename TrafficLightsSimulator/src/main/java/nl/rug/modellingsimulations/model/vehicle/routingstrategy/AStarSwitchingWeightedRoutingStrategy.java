...
public class AStarSwitchingWeightedRoutingStrategy implements RoutingStrategy {
    ...
    public AStarSwitchingWeightedRoutingStrategy(Vehicle vehicle) {
